...
const About = () => {
  ...
  const team = [
    { name: 'Executive Leadership', role: 'Strategic Direction & Vision', img: '/images/team-ceo.jpg' },
    { name: 'Technical Team', role: 'LC3 Process Engineering', img: '/images/team-cto.jpg' },
    { name: 'Finance & Investment', role: 'Capital Structure & Investor Relations', img: '/images/team-cfo.jpg' },
    { name: 'Operations', role: 'Plant Management & Logistics', img: '/images/team-coo.jpg' },
  ];
            ...
            {team.map((member, idx) => (
              ...
              >
                <Card className="text-center">
                  <img src={member.img} alt={member.name} className="h-40 w-full object-cover rounded-xl" />
